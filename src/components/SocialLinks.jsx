...
const SocialLinks = () => {
  return (
    <div className="flex space-x-4 justify-center">
      <a href="https://www.linkedin.com/in/sharful-islam/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors duration-300">
