      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            ...
            <motion.div
              key={index}
              className="border border-gray-600 rounded-lg p-4 flex items-center justify-center space-x-3"
              initial={{ opacity: 0, scale: 0.8 }}
              whileInView={{ opacity: 1, scale: 1 }}
              transition={{ delay: 0.1 * index, duration: 0.4 }}
              whileHover={{ scale: 1.05, transition: { duration: 0.15 } }} // Added transition for whileHover
            >
              {skill.icon}
